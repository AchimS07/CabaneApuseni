...
function icon(content: string | ReactNode, viewBox = '0 0 24 24') {
...
export const SearchIcon = icon(
  'M11 17.25a6.25 6.25 0 1 1 0-12.5 6.25 6.25 0 0 1 0 12.5zm5.5-1.5 3.5 3.5',
);
